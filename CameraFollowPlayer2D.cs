...
public class CameraFollowPlayer2D : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Follow main character, target is the player. This is the more simple way of having the camear follow the player. Camera is fixed to centre with no lerp delay
